...
#
# Script generated by Vivado on Thu Nov 28 15:02:04 +0100 2024
...
#
# Usage        : clock_generator.sh
#                clock_generator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_generator.sh [-reset_run]
#                clock_generator.sh [-reset_log]
#                clock_generator.sh [-help]
#
...
#                script (type 'clock_generator.sh -help' for more information).
#
...
# script info
echo -e "clock_generator.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_generator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clock_generator xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clock_generator -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clock_generator_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: clock_generator.sh [-step]\n\
Usage: clock_generator.sh [-lib_map_path]\n\
Usage: clock_generator.sh [-reset_run]\n\
Usage: clock_generator.sh [-reset_log]\n\
Usage: clock_generator.sh [-keep_index]\n\
