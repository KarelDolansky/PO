...
-- Date        : Thu Dec  5 08:17:30 2024
-- Host        : NORMANDI running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/work/2024/PO/lab08/lab07_video/lab07_video.gen/sources_1/ip/clock_generator/clock_generator_sim_netlist.vhdl
...
entity clock_generator_clk_wiz is
  port (
...
end clock_generator_clk_wiz;

architecture STRUCTURE of clock_generator_clk_wiz is
  ...
  signal video_clk_clock_generator : STD_LOGIC;
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      CLKOUT0 => video_clk_clock_generator,
...
begin
inst: entity work.clock_generator_clk_wiz
     port map (
      clk_in1 => clk_in1,
      locked => locked,
      resetn => resetn,
